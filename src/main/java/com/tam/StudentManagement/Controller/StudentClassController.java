...
public class StudentClassController {
        ...
        @GetMapping("/get-all")
        public ResponseEntity<ApiResponse<List<StudentClassDto>>> getAllStudentClasses() {
                List<StudentClassDto> studentClasses = studentClassService.getAllStudentClasses();
        ...
        public ResponseEntity<ApiResponse<StudentClass>> getStudentClassById(@PathVariable Integer id) {
                return studentClassService.getStudentClassById(id)
                                .map(studentClass -> ResponseEntity
                                                .ok(ApiResponse.success("Get student class successfully",
                                                                studentClass)))
